...
export class GameManager {
    ...
    goto(state) {
        ...
        if (state === MENU_STATE || state === LOGIN_STATE || state === SCORES_STATE || state === DIFFICULTY_STATE || state === THEMES_STATE || state === CREDITS_STATE) {
    ...
    onBackBtn() {
        ...
        if (state === LOGIN_STATE || state === SCORES_STATE || state === DIFFICULTY_STATE || state === THEMES_STATE || state === CREDITS_STATE) {
